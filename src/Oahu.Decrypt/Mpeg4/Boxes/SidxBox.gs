...
open class SidxBox : FullBox {
    ...
    class Segment {
        ...
        prop ReferenceType bool {
            ...
            set -> typeAndSize = if value {
                typeAndSize | 0x80000000U
            } else {
                typeAndSize & uint32(0x7FFFFFFF)
            }
        }
        ...
        prop ReferenceSize int32 {
            ...
            set {
                ArgumentOutOfRangeException.ThrowIfLessThan(value, 0, "ReferenceSize")
        ...
        prop SapType int32 {
            get -> int32((sap >> 28)) & 7
            set {
                ArgumentOutOfRangeException.ThrowIfLessThan(value, 0, "SapType")
                ArgumentOutOfRangeException.ThrowIfGreaterThan(value, 7, "SapType")
        ...
        prop SapDeltaTime int32 {
            ...
            set {
                ArgumentOutOfRangeException.ThrowIfLessThan(value, 0, "SapType")
                ArgumentOutOfRangeException.ThrowIfGreaterThan(value, 0xFFFFFFF, "SapType")
