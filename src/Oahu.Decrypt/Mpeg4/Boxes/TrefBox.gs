...
open class TrefBox : Box {
    ...
    func AddReference(type string, trackIds HashSet[uint32]) TrefBox {
        References.Add(TrackReferenceTypeBox(type, trackIds, this))
        return this
    }
    ...
    private open class TrackReferenceTypeBox : Box, ITrackReferenceTypeBox {
        ...
        init(type string, trackIds HashSet[uint32], parent IBox) : base(BoxHeader(12, type), parent) {
            TrackIds = trackIds
        }
