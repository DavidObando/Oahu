...
class BitReader {
    ...
    prop Position int32 {
        ...
        set {
            ArgumentOutOfRangeException.ThrowIfLessThan(value, 0, "Position")
            ArgumentOutOfRangeException.ThrowIfGreaterThan(value, bytes.Length * 8, "Position")
            byteIndex = value / 8
            bitIndex = value % 8
        }
    }
    ...
    func Read(numBits int32) uint32 {
        var numBits = numBits
        ArgumentOutOfRangeException.ThrowIfLessThan(numBits, 0, "numBits")
        ArgumentOutOfRangeException.ThrowIfGreaterThan(numBits, 4 * 8, "numBits")
