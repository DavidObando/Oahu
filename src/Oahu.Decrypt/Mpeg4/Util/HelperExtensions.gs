...
internal class HelperExtensions {
    shared {
        func AllLessThanOrEqual_256[T IComparable[T]unmanaged](ints Span[T], value T, out checkedcount int32) bool {
            unsafe {
        ...
        func AllLessThanOrEqual_512[T IComparable[T]unmanaged](ints Span[T], value T, out checkedcount int32) bool {
            unsafe {
...
func (ints Span[T]) AllLessThanOrEqual[T IComparable[T]unmanaged](value T) bool {
    unsafe {
        ...
        if Vector512.IsHardwareAccelerated {
            result = HelperExtensions.AllLessThanOrEqual_512(ints, value, out checkedCount)
        } else if Vector256.IsHardwareAccelerated {
            result = HelperExtensions.AllLessThanOrEqual_256(ints, value, out checkedCount)
        } else {
            result = true
            checkedCount = 0
        }
