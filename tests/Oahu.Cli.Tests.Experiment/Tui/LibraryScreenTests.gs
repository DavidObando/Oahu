...
type FakeLibraryService2 class : ILibraryService {
    prop Items IReadOnlyList[LibraryItem] { get { return itemsList } set { itemsList = value } }
    itemsList IReadOnlyList[LibraryItem] = Array.Empty[LibraryItem]()
...
type NullNav class : IAppShellNavigator {
