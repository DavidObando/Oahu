...
class ASCapturingScreen : ITabScreen {
    var TabTitle string = "Test"
    var TabNumberKey char = '1'
    var Capturing bool = false
    var ReceivedL bool = false
    var ReceivedQ bool = false
...
class ScriptedReader : AppShell.IKeyReader {
    var queue Queue[ConsoleKeyInfo] = Queue[ConsoleKeyInfo]()
