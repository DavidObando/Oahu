...
class P8Navigator : IAppShellNavigator {
    var LastSwitch char = char(0)
    var LastToast string? = nil
    var LastModalVal IModal? = nil
...
class LifecycleTabScreen : ITabScreen {
    var TabTitle string = "Tab"
    var TabNumberKey char = '1'
    var ActivatedCount int32 = 0
    var DeactivatedCount int32 = 0
    var ShutdownCount int32 = 0
